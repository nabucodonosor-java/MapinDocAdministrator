...
import com.mapin.docadmin.services.SpecialtyService;
...
public class SpecialtyController {
	...
	public ResponseEntity<Page<SpecialtyDto>> findAll(
		...
		Page<SpecialtyDto> list = service.findAllPaged(pageRequest, name);
	...
	public ResponseEntity<SpecialtyDto> findById(@PathVariable Long id) {
		SpecialtyDto entity = service.findById(id);
	...
	@PutMapping("/{id}")
	public ResponseEntity<SpecialtyDto> update(@PathVariable Long id, @Valid @RequestBody SpecialtyDto dto) {
