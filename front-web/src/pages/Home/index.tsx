      ...
      {isLoading ? (
        ...
        <div className="home-container">
          <div className="home-title">
            <p>
              <span>
                <strong>DocAdmin</strong>
              </span>{" "}
              <br />
              Gerencie tudo que é necessário
              <br /> para impulsionar seu marketing
              <br /> e suas vendas{" "}
            </p>
          ...
          <div className="home-target">
            ...
            <p>
              O objetivo do DocAdmin é ser funcional, interativo e capaz de
              receber atualizações constantes
            </p>
          </div>
          ...
          <div className="home-sections">
            <div className="home-sections-img">
              <p>
                <span>
                  <strong>Médicos, Fisios e TO´s</strong>
                </span>
              </p>
          ...
          <div className="home-sections">
            <div className="home-sections-img">
              <p>
                <span>
                  <strong>Receitas Médicas</strong>
                </span>
              </p>
          ...
          <div className="home-sections">
            <div className="home-sections-img">
              <p>
                <span>
                  <strong>Assistência Social & Apaes</strong>
                </span>
              </p>
