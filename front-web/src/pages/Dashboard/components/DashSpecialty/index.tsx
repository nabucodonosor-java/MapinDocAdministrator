  ...
  return (
    <div className="dash-container">
      <div className="d-none">
        {hpResponse?.content.map((hp) => (
          <>
            ...
            {hp.profession.name === "VASCULAR"
              ? ++countVascular
              : countVascular}
            {hp.profession.name === "NEUROCIRURGIÃO"
              ? ++countNeuro
              : countNeuro}
            ...
            {hp.profession.name === "REUMATOLOGISTA"
              ? ++countReumato
              : countReumato}
            {hp.profession.name === "NEUROLOGISTA"
              ? ++countNeulogista
              : countNeulogista}
          </>
        ))}
      ...
      <div className="base-card dash-specialty">
        <h6>
          Total de Profissionais da Saúde Cadastrados -{" "}
          <u>
            {countOrtho +
              countVascular +
              countNeuro +
