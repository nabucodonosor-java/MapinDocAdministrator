...
import { getAccessTokenDecoded, logout, isAllowedByRole } from 'utils/auth';
    ...
    return (
        <nav className="bg-primary navbar-main">
                ...
                <ul className="navbar-main-menu">
                    ...
                    <li>
                    <NavLink onClick={() => setDrawerActive(false)} className="navbar-link" to="/hp" activeClassName="active" exact>SAÚDE</NavLink>
                    </li>
                    <li>
                    <NavLink onClick={() => setDrawerActive(false)} className="navbar-link" to="/social" activeClassName="active" exact>SOCIAL</NavLink>
                    </li>
                    <li>
                    <NavLink onClick={() => setDrawerActive(false)} className="navbar-link" to="/apae" activeClassName="active" exact>APAE</NavLink>
                    </li>
